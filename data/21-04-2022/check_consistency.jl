...
# plot_3D_result(ground_truth, vmin, vmax; h=K.X.h, x=x, y=y, z=z, filepath=string(figures_folder, "ground_truth_check_new_norear"), ext=".png")
# plot_3D_result(u_conventional, vmin, vmax; h=K.X.h, x=x, y=y, z=z, filepath=string(figures_folder, "conventional_check_new_norear"), ext=".png", aspect="auto")
