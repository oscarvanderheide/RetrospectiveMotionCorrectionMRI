...
experiment_name = "Invivo3D_17-06-2022_SENSE"; println(experiment_name, "\n")
...
# ε_schedule = range(0.1f0, 0.8f0; length=5)
...
println("Conventional reconstruction: ssim = ", ssim_conv, ", psnr = ", psnr_conv)
println("Joint reconstruction: ssim = ", ssim_recon, ", psnr = ", psnr_recon)
