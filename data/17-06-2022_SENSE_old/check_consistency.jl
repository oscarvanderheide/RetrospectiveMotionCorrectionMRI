...
experiment_name = "Invivo3D_17-06-2022_SENSE"
...
opt_parest = parameter_estimation_options(Float32; loss=loss, niter=300, steplength=1f0, λ=0, cdiag=1f-13, cid=1f10, reg_matrix=nothing, interp_matrix=Ip, calibration=calibration_options, verbose=true)
