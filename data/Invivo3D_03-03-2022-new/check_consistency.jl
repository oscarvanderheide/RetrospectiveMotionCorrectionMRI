...
opt_parest = parameter_estimation_options(Float32; loss=loss, niter=10, steplength=1f0, λ=0f0, cdiag=1f-4, cid=1f-1, reg_matrix=nothing, interp_matrix=Ip, calibration=calibration_options, verbose=true)
...
# plot_3D_result(u, vmin, vmax; h=K.X.h, x=x, y=y, z=z, filepath=string(figures_folder, "reconstructed_check", K.readout), ext=".png")